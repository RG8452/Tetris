/*
 *L block
 *Key piece will be in the center of the J
 *dark blue color
 */
...
{
	public static final Color jColor = new Color(13, 67, 230);
	
	public J() //default constructor
	{
		super(jColor);
	...
	/**
	 * Rotation Notation:
	 * Block 0 will always be in the center of the long leg
	 * The rest are pretty irrelevant, they just need to fill positions
	 * rotation 0 is once cw from J
	 */
