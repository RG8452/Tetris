...
public class T extends Tetromino 
{
	...
	/*
	 *rotation notation:
	 *block 0 is always center
	 *blocks 123 will be the edges starting at the top and going clockwise in all scenarios
	 *rotation == 0 means the T is upside down, and 2 means it's right side up
	 */
